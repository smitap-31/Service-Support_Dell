...
namespace Microsoft.BotBuilderSamples.Dialog
{
    ...
    public class QnAMakerBaseDialog : ComponentDialog
    {
        ...
        public const string DefaultNoAnswer = "Please contact our support staff for the same.";
        ...
        public static HeroCard GetHeroCard()
        {
            var heroCard = new HeroCard
            {
                ...
                Text = "Could you please spare a minute to help us improve?" ,
                Buttons = new List<CardAction> { new CardAction(ActionTypes.OpenUrl, "Feedback form", value: "https://forms.gle/3qPRF72SsKHUdJej6") },
            };
