...
<header id="dell-masthead" class="vertical-fill mh-si-state-is-cold" country="in" lang="en" segment="gen" cust-set="incorp1" region="ap" srch-svc="//pilot.search.dell.com/" cust-srv="//www.dell.com/csbapi/en-in/personalization" country-svc="//www.dell.com/csbapi/masthead/countrylist/in/en" persist-srch="false" grey-out-disabled="false" sign-in-flyout-enabled="false" is-homepage="true" cart-service="//www.dell.com/csbapi/en-in/cart" is-p1-nod="false" is-p2-nod="false" component="masthead">
    ...
    <button class="mh-si-button" tabindex="0" aria-expanded="false">
        ...
        <span>
            <span class="mh-si-label" mh-sign-in-label="Sign In">Sign In</span>
        </span>
    </button>
...
<div class="mh-ma-dropdown mh-visibly-hidden">
    ...
    <div class="mh-si-links-wrap">
                        <a href="//www.dell.com/Identity/global/LoginOrRegister/cd2b5dd5-6d9b-4663-92f3-cfad4aff3c94?c=in&amp;l=en&amp;r=ap&amp;s=corp&amp;~ck=mn&amp;redirectUrl=" class="mh-btn mh-btn-primary mh-si-cold-state mh-sign-in-btn">Sign In</a>
                        <a href="//www.dell.com/Identity/global/LoginOrRegister/cd2b5dd5-6d9b-4663-92f3-cfad4aff3c94?c=in&amp;l=en&amp;r=ap&amp;s=corp&amp;~ck=mn&amp;redirectUrl=" class="mh-btn mh-btn-default mh-si-cold-state create-acct-btn">Create an account</a>
                    <a href="//www.dell.com/Identity/global/Login/75814991-4252-4cc4-a977-670cc21309a7?~ck=mn" class="mh-si-links mh-si-cold-state ">Premier Sign In</a>
    ...
    <div class="mh-top-country" component="locale">
        <div id="mh-top-countryselector" class="mh-locale mh-locale-top">
            <div id="mh-top-countrytoggle" class="mh-top-flag-icon">
                <div>
                    <img src="C:\Users\Smita\Downloads\Pictures\4-2-india-flag-png-hd.png" alt="IND" />
                </div>
...
<nav role="navigation" class="mh-no-js">
    ...
    <li>
        ...
        <li class="mh-level-2-children mh-list-menu-trigger">
            ...
            <li class="mh-list-item-2" data-testid="header-navigation-menu-t1-item">
                <button class="mh-list-item-2-trigger" aria-haspopup="true" id="l1_2" tabindex="0">
                    Services
                </button>
            <ul style="position: absolute; z-index: 1000;" class="mh-tier2  mh-dropdown-menu" aria-labelledby="l1_2" data-testid="header-navigation-menu-t2-item">


    <li>
        <a href="//www.dell.com/en-in/work/learn/it-support-lifecycle?~ck=mn" class="mh-tier3-link mh-nav-hover" tabindex="0" data-testid="header-navigation-menu-t1-sub-item">
            View All Services
        </a>
    </li>
    <li>
        <a href="//www.dell.com/support/contents/article/Warranty/consumer-service-store?~ck=mn" class="mh-tier3-link mh-nav-hover" tabindex="0" data-testid="header-navigation-menu-t1-sub-item">
            Support Services for Home
        </a>
    </li>
    <li>
        <a href="//www.dell.com/support/contents/article/Warranty/commercial-service-store?~ck=mn" class="mh-tier3-link mh-nav-hover" tabindex="0" data-testid="header-navigation-menu-t1-sub-item">
            Support Services for Business
        </a>
    </li>
    <li>
        <a href="//www.dell.com/en-in/work/learn/by-service-type-deployment?~ck=mn" class="mh-tier3-link mh-nav-hover" tabindex="0" data-testid="header-navigation-menu-t1-sub-item">
            Deployment Services
        </a>
    </li>
    ...
    <li>
        ...
        <ul class="mh-mn-tier3" aria-labelledby="mn2_1">
                ...
                <li>
                  ...
                  <!--  <ul class="mh-mn-tier2" aria-labelledby="mn1_2">

    <li>
        <a href="//www.dell.com/en-in/work/learn/it-support-lifecycle?~ck=mn" id="mn2_2" role="link" class="">
            View All Services
        </a>
        
    </li>
    <li>
        <a href="//www.dell.com/support/contents/article/Warranty/consumer-service-store?~ck=mn" id="mn2_2" role="link" class="">
            Support Services for Home
        </a>
        
    </li>
    <li>
        <a href="//www.dell.com/support/contents/article/Warranty/commercial-service-store?~ck=mn" id="mn2_2" role="link" class="">
            Support Services for Business
        </a>
        
    </li>
    <li>
        <a href="//www.dell.com/en-in/work/learn/by-service-type-deployment?~ck=mn" id="mn2_2" role="link" class="">
            Deployment Services
        </a>
...
<div class="container">
  ...
  <div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <img src="http://i.dell.com/sites/imagecontent/videos/en/PublishingImages/intel-inspiron-3000-aio-video-en.jpg" alt="PCs" width="700" height="300">
        <div class="carousel-caption">
          <h3>India's #1 trusted brand.</h3>
        </div>
      </div>
    
      <div class="item">
        <img src="http://i.dell.com/sites/csimages/Video_Imagery/all/optiplex-5000-series-rollupimage.jpg" alt="Dell" width="700" height="300">
        <div class="carousel-caption">
          <h3>PCs and Laptops</h3>
